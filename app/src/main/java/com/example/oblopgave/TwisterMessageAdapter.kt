...
class TwisterMessageAdapter<T>(private val items: List<T>, private val onItemClicked: (position: Int) -> Unit) :
    RecyclerView.Adapter<TwisterMessageAdapter.MyViewHolder>() {
